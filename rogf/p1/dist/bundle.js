...
var _Employees = _interopRequireDefault(__webpack_require__(/*! ./Employees.js */ "./src/Employees.js"));
...
function () {
  ...
  _createClass(Controller, [{
    ...
    value: function retrieve() {
      _Employees.default.getAll(this.display);
    }
  }, {
    key: "add",
    value: function add() {
      ...
      _Employees.default.add(name, email, gender, phone, cell);
    ...
    value: function display() {
      ...
      for (var i = 0; i != employees.length; i++) {
        ...
        var rowx = table.insertRow(-1); // Insert new cells (<td> elements) at the 1st and 2nd position of the "new" <tr> element:

        var cell0 = rowx.insertCell(0);
        var cell1 = rowx.insertCell(1);
        var cell2 = rowx.insertCell(2);
        var cell3 = rowx.insertCell(3);
        var cell4 = rowx.insertCell(4);
        var cell5 = rowx.insertCell(5); // Add some text to the new cells:
        ...
        cell4.innerHTML = employees[i].cell; // Create a <button> element

        var btn = document.createElement("BUTTON");
        var t = document.createTextNode("Borrar"); // Create a text node

        btn.appendChild(t);
        btn.addEventListener("click", this.remove);
        btn.value = employees[i].id; // Append the text to <button>
    ...
    value: function remove(e) {
      ...
      _Employees.default.remove(e.target.value);
...
function () {
  ...
  _createClass(Employees, null, [{
        ...
        response.json().then(function (data) {
          ...
          for (var i = 0; i != data.results.length; i++) {
            var employee = {
              ...
              id: (0, _jsSha.sha256)(Math.floor(Math.random() * 1000).toString())
            };
    ...
    key: "add",
    value: function add(name, email, gender, phone, cell) {
      var employee = {
        name: name,
        email: email,
        gender: gender,
